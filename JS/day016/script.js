...
// console.log(`${Ram.firstName} has ${Ram.friends.length} friends, and his best friend is called ${Ram.friends[1]}`);
...
const Ram = {
    ...
    getSummary: function () {
        return `${this.firstName} is a ${this.age()}-year old ${this.job}, and he has ${this.hasDriverLicense ? 'a' : 'not'} driver's license. `
    }
}
const Shyam = {
    firstName: 'Shyam',
...
// Ram is a 46-year old teacher, and he has a driver's license.
// Shyam is a 50-year old teacher, and he has not driver's license.

console.log(Ram.getSummary());
console.log(Shyam.getSummary());
